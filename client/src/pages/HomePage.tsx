...
const TOOLS = [
  ...
  },
  {
    to: '/events',
    icon: '📅',
    label: 'Brokerage Events', description: 'Find EU research networking and matchmaking events from the Enterprise Europe Network, filterable by cluster and country.',
  },
  {
    to: '/graph',
  ...
  },
  {
    to: '/msca',
    icon: '🎓',
    label: 'MSCA Explorer', description: 'Search Marie Skłodowska-Curie Actions projects and discover host organisations for fellowships and doctoral networks.',
  },
];
