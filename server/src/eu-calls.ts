...
export const EU_FUNDING_CALLS: FundingCall[] = [
  {
    ...
    fundingType: 'blended',
    typicalSuccessRate: '5–8%',
    applicationEffortHours: 300,
    timeToMoneyMonths: 12,
  ...
  },
  {
    ...
    minCountries: 3,
    fundingType: 'grant',
    typicalSuccessRate: '5–10%',
    applicationEffortHours: 150,
    timeToMoneyMonths: 10,
  ...
  },
  {
    ...
    minCountries: 3,
    fundingType: 'grant',
    typicalSuccessRate: '10–15%',
    applicationEffortHours: 200,
    timeToMoneyMonths: 9,
  ...
  },
  {
    ...
    consortiumRequired: false,
    fundingType: 'grant',
    typicalSuccessRate: '20–30%',
    applicationEffortHours: 100,
    timeToMoneyMonths: 8,
  ...
  },
  {
    ...
    typicalSuccessRate: 'N/A — via intermediaries',
    applicationEffortHours: 20,
    timeToMoneyMonths: 2,
